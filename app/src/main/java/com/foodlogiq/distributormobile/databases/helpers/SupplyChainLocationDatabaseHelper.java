 ...
 */
public class SupplyChainLocationDatabaseHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "supplyChainLocations.db";
    private static final int DATABASE_VERSION = 1;

    public SupplyChainLocationDatabaseHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        SupplyChainLocationTable.onCreate(sqLiteDatabase);
    }
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i2) {
        SupplyChainLocationTable.onUpgrade(sqLiteDatabase, i, i2);
    }
}
